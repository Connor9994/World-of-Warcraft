...
ZygorGuidesViewer:RegisterGuidePlaceholder("Dailies Guides\\Mists of Pandaria Dailies\\Operation: Shieldwall")
ZygorGuidesViewer:RegisterGuidePlaceholder("Dailies Guides\\Mists of Pandaria Dailies\\Beastmaster Dailies")
ZygorGuidesViewer:RegisterGuidePlaceholder("Dailies Guides\\Mists of Pandaria Dailies\\Kirin Tor Offensive Dailies")
