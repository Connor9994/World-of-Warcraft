...
ZygorGuidesViewer:RegisterGuide("Leveling Guides\\Legion (10-50)\\Legion Intro",{
	...
	step
		...
		Kill #33# Demons |scenariogoal 2/27653 |goto 48.4,70.5 |q 42740 |only if haveq(42740) or completedq(42740)
		Kill #33# Demons |scenariogoal 2/27653 |goto 48.4,70.5 |q 43806 |only if haveq(43806) or completedq(43806)
	step
	label "fel_lords1"
		Kill enemies around this area
		|tip Follow the group.
		Kill #3# Fel Lords |scenariogoal 2/29377 |goto 48.4,70.5 |q 42740 |only if haveq(42740) or completedq(42740)
		Kill #3# Fel Lords |scenariogoal 2/29377 |goto 48.4,70.5 |q 43806 |only if haveq(43806) or completedq(43806)
	step
	label "spires_of_woe"
		kill Anchoring Crystal##91704+
		|tip Follow the group.
		Destroy #3# Spires of Woe |scenariogoal 2/27619 |goto 48.4,70.5 |q 42740 |only if haveq(42740) or completedq(42740)
		Destroy #3# Spires of Woe |scenariogoal 2/27619 |goto 48.4,70.5 |q 43806 |only if haveq(43806) or completedq(43806)
	step
		kill Dread Commander Arganoth##90705 |goto 48.4,70.5 |scenariogoal 3/30883 |q 42740 |only if haveq(42740) or completedq(42740)
		kill Dread Commander Arganoth##90705 |goto 48.4,70.5 |scenariogoal 3/30883 |q 43806 |only if haveq(43806) or completedq(43806)
	step
		Run up the path |goto 49.40,66.41 < 30
		Watch the dialogue
		|tip Follow the group.
		Find Varian |scenariostage 4 |goto 38.07,47.13 |q 42740 |only if haveq(42740) or completedq(42740)
		Find Varian |scenariostage 4 |goto 38.07,47.13 |q 43806 |only if haveq(43806) or completedq(43806)
	step
		kill Shielded Anchor##101667+
		|tip They look like big floating green crystals.
		Shatter #4# Shielded Anchors |scenariogoal 5/27940 |goto 39.0,43.7 |q 42740 |only if haveq(42740) or completedq(42740)
		Shatter #4# Shielded Anchors |scenariogoal 5/27940 |goto 39.0,43.7 |q 43806 |only if haveq(43806) or completedq(43806)
	step
		Watch the dialogue
		|tip Follow the group.
		Kill enemies all around this area
		Assault the Demon City |scenariostage 6 |goto 44.7,47.5 |q 42740 |only if haveq(42740) or completedq(42740)
		Assault the Demon City |scenariostage 6 |goto 44.7,47.5 |q 43806 |only if haveq(43806) or completedq(43806)
	step
		Watch the dialogue
		|tip Follow the group.
		Get to Tirion |scenariostage 7 |goto 55.8,32.2 |q 42740 |only if haveq(42740) or completedq(42740)
		Get to Tirion |scenariostage 7 |goto 55.8,32.2 |q 43806 |only if haveq(43806) or completedq(43806)
	step
		Kill enemies around this area
		kill Krosus##90544
		Slay Krosus |scenariostage 8 |goto 55.8,32.2 |q 42740 |only if haveq(42740) or completedq(42740)
		Slay Krosus |scenariostage 8 |goto 55.8,32.2 |q 43806 |only if haveq(43806) or completedq(43806)
	step
		Follow the path up |goto 55.98,31.21 < 20
		Watch the dialogue
		|tip Follow the group
		Kill the enemies that attack in waves
		Confront Gul'dan |scenarioend |goto 58.3,27.5 |q 42740 |only if haveq(42740) or completedq(42740)
		Assault the Broken Shore |q 42740/2 |goto 58.3,27.5 |only if haveq(42740) or completedq(42740)
		Confront Gul'dan |scenarioend |goto 58.3,27.5 |q 43806 |only if haveq(43806) or completedq(43806)
		Assault the Broken Shore |q 43806/1 |goto 58.3,27.5 |only if haveq(43806) or completedq(43806)
	step
